...
export default async function SharedBriefPage({ params }: Props) {
  ...
  return (
    <main className="min-h-screen bg-bg py-12 px-6">
      <div className="max-w-3xl mx-auto bg-panel border border-border rounded-lg p-10 shadow-sm">
        {/* Header */}
        ...
        {tracks?.map((track: any) => {
          ...
          const elems = allElements.filter((e: any) => e.track_id === track.id);
        ...
        <div className="text-center">
          <p className="text-xs text-faint">
            Generated by Mix Architect &middot; mixarchitect.com
          </p>
        </div>
      </div>
    </main>
