...
export const articles: HelpArticle[] = [
  {
    ...
    "content": [
      ...
      },
      {
        ...
        "body": "Veröffentlichungen sind Ihre übergeordneten Projekte (Alben, EPs oder Singles). Jede Veröffentlichung enthält einen oder mehrere Tracks. Auf dem Desktop hat die Detailseite einer Veröffentlichung ein Zwei-Spalten-Layout: die Trackliste links und eine Inspektor-Seitenleiste rechts, die das Cover, die Veröffentlichungsinfos (Künstler, Typ, Format, Status, Zieldatum, Genre), die Globale Mix-Richtung, Globale Referenzen und den Zahlungsstatus anzeigt. Jeder Track hat sechs Tabs: Intention, Spezifikationen, Audio, Distribution, Portal und Notizen. Klicken Sie auf das Zahnrad-Symbol in der Kopfzeile der Veröffentlichung, um die Veröffentlichungseinstellungen zu öffnen, wo Sie alle Metadaten bearbeiten, Ihr Team verwalten und die Zahlung konfigurieren können. Die Kopfzeile enthält außerdem Schaltflächen für den Portal-Umschalter (mit einem Link zum Öffnen des Portals), Als Vorlage speichern und das Einstellungs-Zahnrad.",
        "mockup": "key-concepts"
      }
    ]
  },
  ...
  },
  {
    ...
    "category": "releases",
    "summary": "Jeder Track hat sechs Tabs zur Verwaltung aller Aspekte Ihres Mixes: Intention, Spezifikationen, Audio, Distribution, Portal und Notizen.",
    "tags": [
      "tracks",
      "tabs",
      "intent",
