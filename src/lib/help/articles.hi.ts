...
export const articles: HelpArticle[] = [
  ...
  },
  {
    ...
    "category": "releases",
    "summary": "प्रत्येक ट्रैक में आपके mix के हर पहलू को manage करने के लिए छह tabs हैं: Brief, Audio, Delivery और Notes।",
    "tags": [
      "tracks",
      "tabs",
      "intent",
  ...
  },
  {
    ...
    "content": [
      ...
      },
      {
        ...
        "body": "Spotify, Distribution Tracker में सबसे ऊपर \"Updates automatically\" label के साथ listed है। एक बार जब आप Spotify को Submitted के रूप में mark करते हैं, Mix Architect समय-समय पर ISRC code (track के Delivery tab से) या release title और artist name का उपयोग करके Spotify catalog में आपकी रिलीज़ की जाँच करता है। जब आपकी रिलीज़ Spotify पर मिलती है, तो status स्वचालित रूप से Live में बदल जाता है, Spotify URL सहेजा जाता है, और आपको notification मिलता है। तुरंत जाँच शुरू करने के लिए आप \"Check Now\" पर भी क्लिक कर सकते हैं। Auto-detection सभी submitted Spotify entries के लिए प्रतिदिन चलता है।",
        "tip": "Submit करने से पहले अपने track के Delivery tab पर ISRC code भरें। ISRC-आधारित detection, title/artist matching से अधिक विश्वसनीय है, विशेषकर सामान्य नामों के लिए।",
  ...
  },
  {
    ...
    "content": [
      ...
      },
      {
        ...
        "body": "जब आप MP3, FLAC, AAC, OGG, या ALAC में convert करते हैं, Mix Architect स्वचालित रूप से industry-standard metadata tags output file में लिखता है। इसमें शामिल हैं: artist, title, album, track number, genre, release year, copyright, ISRC, UPC/barcode, lyrics, cover art, और ReplayGain। ReplayGain एक loudness tag है जो compatible players को बताता है कि volume कितना adjust करना है ताकि tracks consistent level पर playback हों बिना clipping के। Mix Architect इसे आपके audio की measured LUFS से ReplayGain 2.0 standard (reference level -18 LUFS) का उपयोग करके calculate करता है। MP3 files को ID3v2 tags मिलते हैं, FLAC और OGG Vorbis comments का उपयोग करते हैं, और AAC/ALAC iTunes-style MP4 atoms का उपयोग करते हैं। सभी metadata आपकी release और track details से लिया जाता है (Delivery tab से ISRC और lyrics, और release cover art सहित)। WAV और AIFF exports में metadata tags शामिल नहीं होते। Conversion पूरा होने के बाद, format chip के बगल में tag आइकन पर hover करें यह देखने के लिए कि ठीक कौन से tags embed किए गए।",
        "tip": "Export करने से पहले अपना Delivery tab (ISRC, lyrics) भरें और cover art अपलोड करें। आप जितना अधिक metadata प्रदान करेंगे, distribution के लिए आपकी exported files उतनी ही पूर्ण होंगी।"
      },
      {
        "heading": "Supported Formats Reference",
        "body": "Lossless formats source quality बनाए रखते हैं: WAV (PCM, source rate/depth), AIFF (PCM, source rate/depth), FLAC (source rate), ALAC (source rate)। Lossy formats distribution के लिए optimized fixed presets उपयोग करते हैं: MP3 (44.1 kHz, 320 kbps, stereo), AAC (44.1 kHz, 256 kbps, stereo), OGG Vorbis (44.1 kHz, quality 8, stereo)। Non-convertible formats (केवल tag, कोई auto-conversion नहीं): DDP, ADM BWF (Atmos), MQA। Brief tab के शीर्ष पर Technical Settings (sample rate और bit depth) source audio का वर्णन करने वाले reference metadata हैं; ये conversion output को नियंत्रित नहीं करते। Delivery formats के नीचे Special Requirements text area आपको delivery निर्देशों के बारे में notes जोड़ने देता है।",
