  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        body: "Once you have selected your delivery formats in the Specs tab, click the download arrow icon next to any selected convertible format to start a conversion. The icon shows a spinner while the conversion is processing in the background. When the conversion completes, the file downloads automatically to your browser. You will also receive an in-app notification when the conversion finishes. Each conversion uses the audio version you selected in the \"Export from\" dropdown, converting from the original uploaded file to preserve maximum audio quality.",
        tip: "For distribution, most platforms accept 16-bit/44.1kHz WAV or FLAC. Check your distributor's requirements before converting. You can adjust the sample rate and bit depth in the Technical Settings section at the top of the Specs tab.",
        mockup: "export-download",
      },
      {
        heading: "Supported Formats Reference",
        body: "Convertible formats (auto-conversion available): WAV, AIFF, FLAC, MP3, AAC, OGG, ALAC. Non-convertible formats (tag only, no auto-conversion): DDP, ADM BWF (Atmos), MQA. The converter always works from the original uploaded source file at its native resolution. You can override the output sample rate and bit depth per track using the Technical Settings dropdowns at the top of the Specs tab. The Special Requirements text area below the delivery formats lets you add notes about delivery instructions.",
