...
export const articles: HelpArticle[] = [
     ...
     ────────────────────────────────────────────────────── */
  {
    ...
    tags: ["tracks", "tabs", "brief", "audio", "delivery", "notes", "lufs", "true peak", "quality", "loudness"],
    ...
    content: [
      ...
      },
      {
        ...
        body: "When you upload audio, Mix Architect automatically measures the integrated loudness in LUFS (Loudness Units Full Scale) on the server and caches it. Click the LUFS pill next to the version metadata to expand the Loudness Analysis popover. This shows how every major streaming service, broadcast standard, and social platform will adjust your track during playback. Each row displays the platform name, its target loudness (e.g. Spotify targets -14 LUFS), and the gain change that would be applied to your file. A positive value means the service will turn your track up; a negative value (shown in orange) means it will be turned down. For example, if your mix measures -14.9 LUFS, Spotify would apply +0.9 dB while Apple Music (target -16) would apply -1.1 dB. Hover any platform name to see a short explanation of how that platform normalizes audio. The popover is grouped into Streaming (Spotify, Apple Music, YouTube, Tidal, Amazon Music, Deezer, Qobuz, Pandora), Broadcast (EBU R128, ATSC A/85, ITU-R BS.1770), and Social (Instagram/Reels, TikTok, Facebook). Click anywhere outside the popover to close it. Use this to check whether your master will be significantly altered on any platform before delivery.",
