    ...
    "content": [
      {
        ...
        "body": "Abre [Configuración de Usuario](/app/settings) desde la barra lateral o el menú de cuenta en la barra superior. La configuración está organizada en paneles: Perfil, Suscripción, Región y Moneda, Apariencia, Persona, Seguimiento de Pagos, Preferencias de Correo, Valores Predeterminados de Mezcla, Calendario y Tus Datos. Los cambios se guardan al instante cuando interactúas con cada panel.",
