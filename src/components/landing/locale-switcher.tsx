  ...
  return (
    <div ref={wrapperRef} className="relative">
      ...
      <button
        ...
        className="flex items-center gap-1.5 border border-white/10 rounded-lg px-1.5 sm:px-2 py-1.5 text-sm text-zinc-300 hover:border-[#0D9488]/50 hover:text-white transition-colors cursor-pointer"
      >
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-2.5 px-3 py-2 text-sm transition-colors cursor-pointer outline-none focus-visible:bg-white/5 ${
                  isActive
                    ? "text-[#0D9488] border-l-2 border-[#0D9488] pl-[10px]"
